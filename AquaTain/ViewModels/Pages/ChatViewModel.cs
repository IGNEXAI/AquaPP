...
public partial class ChatViewModel : PageBase
{
    ...
    public ChatViewModel(ISukiToastManager toastManager) : base("Chat", "fa-solid fa-comment")
    {
        ...
        UserImage = new Bitmap(AssetLoader.Open(new Uri("avares://AquaTain/Assets/avatar_image.jpeg")));
        AgentImage = new Bitmap(AssetLoader.Open(new Uri("avares://AquaTain/Assets/svg-chatbot-icon--freesvgorg133669.png")));
